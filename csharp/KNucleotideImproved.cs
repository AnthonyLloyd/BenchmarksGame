...
public static class KNucleotide
{
    ...
    {
        var stream = File.OpenRead(@"C:\temp\input25000000.txt");
    ...
    public static void Main(string[] args)
    {
        ...
        Dbg.Instance.Checkpoint("Load");
        var task18 = count(18, 34359738367, d => writeCount(d, "GGTATTTTAATTTATAGT")).Result;
        Dbg.Instance.Checkpoint("18");
        var task12 = count(12, 8388607, d => writeCount(d, "GGTATTTTAATT")).Result;
        Dbg.Instance.Checkpoint("12");
        var task6 = count(6, 0b1111111111, d => writeCount(d, "GGTATT")).Result;
        Dbg.Instance.Checkpoint("6");
        var task4 = count(4, 0b111111, d => writeCount(d, "GGTA")).Result;
        Dbg.Instance.Checkpoint("4");
        var task3 = count(3, 0b1111, d => writeCount(d, "GGT")).Result;
        Dbg.Instance.Checkpoint("3");
        var task2 = count(2, 0b11, d => writeFrequencies(d, 2)).Result;
        Dbg.Instance.Checkpoint("2");
        var task1 = count(1, 0, d => writeFrequencies(d, 1)).Result;
        Dbg.Instance.Checkpoint("1");
