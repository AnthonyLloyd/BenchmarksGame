...
{
    const long chkMask = uint.MaxValue, oneFlip = chkMask+1, flipMask = oneFlip * int.MaxValue;
    ...
    {
        return (Math.Max(l1,l2) & flipMask) | ((l1+l2) & chkMask);
    }
